...
Options are:
    ...
    -p, --pattern [PATTERN]          		run tests matching this pattern
    	--environment-variables '[options]' 	Inject environment variables into tasks
...
====
 ...
 - Use your regular format when setting environment variables (--environment-variables 'VARIABLE=value')
